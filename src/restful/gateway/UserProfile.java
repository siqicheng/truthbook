...
//		Object value[] = {user,"1"};
//		
//		List portrait_list = this.portraitDAO.findByProperties(property, value, Portrait.TABLE);
...
//	public String setDefaultPortrait(@PathParam("id") Integer id,@PathParam("image_id") Integer image_id){
//		User user = new User();
//		user.setUserId(id);
...
//	@Produces(MediaType.TEXT_PLAIN)
//	public String deletePortrait(@PathParam("id") Integer id,@PathParam("image_id") Integer image_id){
//		User user = new User();
//		user.setUserId(id);
//		Image image = new Image();
//		image.setImageId(image_id);		
...
//	
	...
	public User[] getFriends(@PathParam("id") Integer id,@PathParam("type") String type) throws Exception {
		...
		List relationships = this.relationshipDAO.findByProperties(property, value, Relationship.TABLE);
		if (relationships.size() > 0){
			List friend_list = new ArrayList();
			for (Object relationship : relationships){
				if (relationship instanceof Relationship){
					Integer friend_id = ((Relationship) relationship).getFriendId();
...
//	@Produces(MediaType.TEXT_PLAIN)
//	public String updateFriend(@PathParam("user_id") Integer user_id,@PathParam("friend_id") Integer friend_id,@PathParam("rs_type") String rs_type){
//		User user = new User();
...
//		Transaction tx = session.beginTransaction();
//		try{					
//			List relationship_list = this.relationshipDAO.findByProperties(property,value,Relationship.TABLE);
//			
...
//	@Path("v1/addFriend")
//	@Produces(MediaType.TEXT_PLAIN)
//	public String addFriend(@FormParam("user_id") Integer user_id,@FormParam("friend_id") Integer friend_id,@FormParam("rs_type") String rs_type,@FormParam("is_invitee") String is_invitee){
//		User user = new User();
//		user.setUserId(user_id);
//		
//		String property[] = {Relationship.USER_ID,Relationship.FRIEND_ID,Relationship.RELATIONSHIP};
...
//	@Produces(MediaType.TEXT_PLAIN)
//	public String deleteFriend(@PathParam("user_id") Integer user_id,@PathParam("friend_id") Integer friend_id,@PathParam("rs_type") String rs_type){
//		User user = new User();
//		user.setUserId(user_id);
//		
//		String property[] = {Relationship.USER_ID,Relationship.FRIEND_ID,Relationship.RELATIONSHIP};
